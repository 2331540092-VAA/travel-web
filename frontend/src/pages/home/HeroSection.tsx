    ...
    <section className="relative rounded-[2.5rem] overflow-hidden mb-24 shadow-2xl">
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-20">
        <div className="max-w-3xl text-white">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight flex flex-col gap-2 md:gap-4">
            <span>Khám phá vẻ đẹp</span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 pb-2">
              Châu Á đích thực
            </span>
          </h1>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-11/12 max-w-4xl bg-white/10 backdrop-blur-xl border border-white/20 p-2 text-white rounded-full hidden md:flex items-center gap-2 shadow-2xl">
        ...
        <div className="flex-1 flex items-center gap-3 px-6 border-r border-white/20">
          ...
          <div className="flex flex-col">
            <span className="text-xs text-slate-300 font-medium">Khởi hành</span>
            <input 
              type="date" 
              value={date}
        ...
        <div className="flex-1 flex items-center gap-3 px-6">
          ...
          <div className="flex flex-col">
            <span className="text-xs text-slate-300 font-medium">Hành khách</span>
            <input 
              type="text" 
              value={guests}
        ...
        <button onClick={handleSearch} className="bg-cyan-500 hover:bg-cyan-400 text-white p-4 rounded-full transition-colors flex-shrink-0">
          <Search className="w-5 h-5" />
        </button>
      </div>
    </section>
