  ...
  return (
    <section className="relative rounded-[2.5rem] overflow-hidden mb-24 shadow-2xl">
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-20">
        ...
        >
          ...
          <h1 className="font-extrabold mb-6 tracking-tight">
            <div className="text-5xl md:text-7xl leading-none mb-2 text-white">
              Khám phá vẻ đẹp
            </div>
            <div
              className="text-5xl md:text-7xl leading-none text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500"
      ...
      >
        ...
        <div className="flex-[1.2] flex items-center gap-3 px-6 border-r border-white/20">
