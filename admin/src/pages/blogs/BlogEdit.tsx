...
export default function BlogEdit() {
  ...
  if (loading) return <p className="p-6 space-y-6 max-w-5xl mx-auto">Loading blog...</p>;
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 md:p-8 rounded-2xl border border-gray-100 shadow-sm space-y-5">
        ...
        {/* Cover URL */}
        <div>
          <label className="block mb-1.5 text-sm font-semibold text-gray-700">Cover Image URL</label>
          <input
            type="text"
            name="cover_url"
        ...
        {/* Content */}
        <div>
          <label className="block mb-1.5 text-sm font-semibold text-gray-700">Content</label>
          <textarea
            name="content"
