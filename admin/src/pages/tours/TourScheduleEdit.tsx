...
export default function TourScheduleEdit() {
  ...
  if (loading) return <p className="p-6 space-y-6 max-w-5xl mx-auto">Loading schedule...</p>;
  ...
  return (
    <div className="flex flex-col mb-6 items-start">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-md">
        <div>
          <label className="block mb-1.5 text-sm font-semibold text-gray-700">Day Number</label>
          <input
            type="number"
            name="day_number"
        ...
        <div>
          <label className="block mb-1.5 text-sm font-semibold text-gray-700">Title</label>
          <input
            type="text"
            name="title"
        ...
        <div>
          <label className="block mb-1.5 text-sm font-semibold text-gray-700">Activity</label>
          <textarea
            name="activity"
